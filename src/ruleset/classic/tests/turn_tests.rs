...
mod tests {
    ...
    fn en_passant_test1() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_B7, FIELD_B5, None));
    ...
    fn en_passant_test2() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_C5, FIELD_B6, None));
    ...
    fn promotion_test_1() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_A7, FIELD_A8, Some(PieceType::Queen)));
    ...
    fn promotion_test_2() {
        let original_position = FEN::import("8/P7/8/8/8/8/8/8 w - - 0 1").unwrap();
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_A7, FIELD_A8, Some(PieceType::Bishop)));
    ...
    fn castling_test_1() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_E1, FIELD_G1, None));
    ...
    fn castling_test_2() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_E1, FIELD_C1, None));
    ...
    fn castling_test_3() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_E8, FIELD_G8, None));
    ...
    fn castling_test_4() {
        ...
        let position = CLASSIC_RULESET.execute_turn(&original_position, &Turn::new(FIELD_E8, FIELD_C8, None));
